...
function buildTypeScript(protoFiles) {
    return __awaiter(this, void 0, void 0, function () {
        var tempDir, jsFile, jsonDescriptor, root, js, _a, _b, tsFile, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 7:
                    tsFile = _e.sent();
                    _c = transformTypeScriptSource;
                    return [4 /*yield*/, mz_1.fs.readFile(tsFile, 'utf8')];
                case 8: return [2 /*return*/, _c.apply(void 0, [_e.sent()])];
                case 9:
