...
describe('multiple services test', function () {
    var namespaces;
    ...
    it('should compile server', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
    ...
    it('should compile client', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            result = utils_1.compileInMemory({
                'grpc-namespaces.ts': namespaces,
...
//# sourceMappingURL=multiple-services.test.js.map